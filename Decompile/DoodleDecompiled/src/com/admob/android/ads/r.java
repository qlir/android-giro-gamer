  ...
  implements Runnable
{
  ...
  public static String c()
  {
    ...
    for (;;)
    {
      ...
      n = String.format("Mozilla/5.0 (Linux; U; Android %s) AppleWebKit/525.10+ (KHTML, like Gecko) Version/3.0.4 Mobile Safari/523.12.2 (AdMob-ANDROID-%s)", new Object[] { localStringBuffer, "20100709" });
...
/* Location:              F:\Java\android-giro-gamer\Decompile\1\doodle_dex2jar.jar!\com\admob\android\ads\r.class
